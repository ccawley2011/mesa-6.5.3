...
void display(void)
{
   ...
   GLfloat diffuse1[] = {0.0, 0.7, 0.7, 1.0 };
   GLfloat specular1[] = {0.0, 1.0, 1.0, 1.0 };
   GLfloat position2[] = { 1.3, 0.0, -0.75, 1.0 };
   GLfloat diffuse2[] = {0.7, 0.7, 0.0, 1.0 };
   GLfloat specular2[] = {1.0, 1.0, 0.0, 1.0 };
   GLfloat position3[] = { -1.3, 0.0, -0.75, 1.0 };
   GLfloat diffuse3[] = {0.7, 0.0, 0.0, 1.0 };
   GLfloat specular3[] = {1.0, 0.0, 0.0, 1.0 };
   GLfloat ambient[] = {0.0, 0.0, 0.0, 1.0};

   GLfloat colour[] = {0.7, 0.7, 0.7, 1.0 };
   GLfloat highlight[] = {1.0, 1.0, 1.0, 1.0 };
...
void setup( void )
{
	...
	strcpy((char *)&window_block[19], "Cone");

	strcpy((char *)menu_block, "Cone");
...
/* -------------------------------------------------------------------------------- */
   ...
   poll(rotate, display, keyboard, mouse);
   end();
   exit(0);
}
